...
export const projects: Project[] = [
  {
    ...
    tags: ["Мобильное приложение", "Рестораны", "Бронирование"],
    cover: "/projects/meet-up/cover.webp",
    summary:
      "Приложение для выбора ресторана: карта заведений рядом, поиск по конкретному блюду, бронь столика и предзаказ меню в одном сценарии.",
    blocks: [
      {
        type: "text",
        title: "Задача",
        body:
          "Выбор ресторана обычно распадается на несколько приложений: в одном смотрят карту и отзывы, в другом изучают меню, столик бронируют звонком. Нужно было собрать весь путь — от «где поесть рядом» до подтверждённой брони — внутри одного экрана.",
      },
      {
        type: "screens",
        items: [
      ...
      },
      {
        ...
        title: "Решение",
        body:
          "Навигацию построили вокруг карты: заведения, подборки и фильтры живут в шторке поверх неё, поэтому район всегда остаётся перед глазами. Поиск понимает не только название и метро, но и блюдо: по запросу «шашлык» приложение показывает и позиции меню, и рестораны, где их готовят.",
      },
      {
        type: "text",
      ...
      },
      {
        ...
        items: [
          ...
          { value: "8", label: "подборок на главном экране" },
